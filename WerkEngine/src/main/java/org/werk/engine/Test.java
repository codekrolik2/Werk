...
public class Test {
	...
	public static void main(String[] args) throws WerkParameterException {
		...
		{
			StringParameter p = (StringParameter)jobContext.getJobParameter("s1");
			System.out.println(p);
			System.out.println(p.getValue());
			i.s1 = "HELLO";
			System.out.println(p.getValue());
			jobContext.putJobParameter("s1", new StringParameterImpl("WORLD"));
		...
		{
			StringParameter p = (StringParameter)stepContext.getStepParameter("s2");
			System.out.println(p);
			System.out.println(p.getValue());
			i.s2 = "HELLO2";
			System.out.println(p.getValue());
			stepContext.putStepParameter("s2", new StringParameterImpl("WORLD2"));
